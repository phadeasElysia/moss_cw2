...
def TCP_calculator(UIC,name):
    ...
    # Introduce 90% loan to heat pumps
    elif name == "GSHP":
        return 0.1*UIC + electricity_price * 36 + DC
    elif name == "ASHP":
        return 0.1*UIC + electricity_price * 36 + DC
    else:
        return
...
if __name__ == '__main__':
    ...
    ban_subsidy_90 = pd.DataFrame(results, columns=columns)
    with open('ban_subsidy_90.pickle', 'wb') as file:
        pickle.dump(ban_subsidy_90, file)
